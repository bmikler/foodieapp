INSERT INTO
    item(item_id, price, name, short_description, description, image_url)
VALUES
    ...
    'ręcznie przygotowanym sosem pomidorowym i oryginalnym serem mozarella','/image/pizza-margharita.jpg'),
    ...
    'lokalnych upraw oraz świeże zioła.','/image/spaghetti-bolognese.jpg'),
    ...
    'w alternatywnej wersji z sosem czekoladowym.','/image/panna-cotta.jpg');

INSERT INTO
    client_order(order_id, address, telephone, order_status)
VALUES
